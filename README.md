...
```
rmsk<-biomartr::read_rm("../test/mm10_test/mm10.fa.out") 
...
# input.file <- read.csv("../test/mm10_test/forebrain_16_5_rep_1_peaks.narrowPeak", header=TRUE, stringsAsFactors=FALSE)
