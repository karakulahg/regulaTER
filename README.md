...
2. Read the repeat track information for your genome of interest in RepeatMasker file format, as obtained from the [RepBase database](https://www.girinst.org/repbase/), as well as your genomic sequencing peak information, generated by MACS2 and annotated by ChIPseeker, in one of narrowPeak, broadPeak, or summits formats. For details on the format of annotated BED files, see "ChIPseeker Annotations Compatible with ShufflePeaks and TEAR Functions" below these instructions.
```
