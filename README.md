...
peak.16_5 <- read.table("../test/mm10_test/", sep = "\t", header=TRUE)
...
start <- Sys.time()
print(start)
enrich.peak.16.5 <- EnrichPARs(inputPeakFile = peak.16_5 , pathList = pathList, numberOfShuffle = 2, repeatMaskerFile = raw.rmsk, format="narrow", minoverlap=0L)
end <- Sys.time()
print(end)
